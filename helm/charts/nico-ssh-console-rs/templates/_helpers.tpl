...
*/}}
{{- define "nico-ssh-console-rs.namespace" -}}
...
*/}}
{{- define "nico-ssh-console-rs.name" -}}
...
*/}}
{{- define "nico-ssh-console-rs.chart" -}}
...
Common labels
*/}}
{{- define "nico-ssh-console-rs.labels" -}}
...
*/}}
{{- define "nico-ssh-console-rs.serviceMonitorSpec" -}}
endpoints:
  - honorLabels: false
