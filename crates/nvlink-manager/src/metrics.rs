...
impl NvlPartitionMonitorInstruments {
    pub fn new(
        ...
        let operations_latency = meter
            .f64_histogram("nico_nvlink_partition_monitor_nmxm_op_latency")
        ...
        let nmxm_changes_applied = meter
            .u64_counter("nico_nvlink_partition_monitor_nmxm_changes_applied")
...

        {
            let metrics = shared_metrics.clone();
            meter
                .u64_observable_gauge("nico_nvlink_partition_monitor_nmxm_connect_error_count")
...

        {
            let metrics = shared_metrics.clone();
            meter
                .u64_observable_gauge("nico_nvlink_partition_monitor_nmxm_partition_count")
...

        {
            let metrics = shared_metrics.clone();
            meter
                .u64_observable_gauge("nico_nvlink_partition_monitor_nmxm_gpu_count")
