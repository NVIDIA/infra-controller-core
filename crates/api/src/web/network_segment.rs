...
impl From<nicorpc::NetworkSegment> for NetworkSegmentRowDisplay {
    fn from(segment: nicorpc::NetworkSegment) -> Self {
        Self {
...
impl From<nicorpc::NetworkSegment> for NetworkSegmentDetail {
    fn from(segment: nicorpc::NetworkSegment) -> Self {
