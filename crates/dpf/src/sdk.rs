...
use crate::types::{
    ...
    DpuDeviceInfo, DpuMismatch, DpuNodeInfo, DpuPhase, DpuServiceInterfaceTemplateDefinition,
    ...
    pub async fn find_outdated_dpus_dpf(
        ...
        let mismatches = dpus
            ...
            .filter_map(|dpu| {
                ...
                let flavor_matches = dpu.spec.dpu_flavor.as_deref() == Some(expected_flavor);
