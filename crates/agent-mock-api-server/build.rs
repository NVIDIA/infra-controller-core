...
// RPC methods mocked by carbide-agent-mock-api-server. We don't implement all of forge.proto
// because we would need an unreasonably large number of stub functions.
static KEEP_RPCS: &[&str] = &[
    "Version",
    "GetManagedHostNetworkConfig",
    "RecordDpuNetworkStatus",
    "DpuAgentUpgradeCheck",
    "DiscoverMachine",
    "FindInterfaces",
    "GetDpuInfoList",
    "UpdateAgentReportedInventory",
];
