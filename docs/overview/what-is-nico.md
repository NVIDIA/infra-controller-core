...
- **PostgreSQL** — stores all NICo system state in the `forgedb` database. Only the API Service reads from and writes to it. The reference deployment uses the Zalando Postgres Operator with Spilo-15.
